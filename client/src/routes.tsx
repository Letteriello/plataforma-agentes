...
const CofrePage = lazy(() => import('@/features/secrets-vault/routes/Cofre').then(module => ({ default: module.CofrePage })));
const SettingsPage = lazy(() => import('@/features/common/routes/SettingsPage'));
const DeployPage = lazy(() => import('@/features/common/routes/DeployPage'));
