...
const TypographyShowcase = () => (
  <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl max-w-none">
    ...
    <section>
      <h2>Font Families</h2>
      <p>These are defined in <code>client/src/theme/index.ts</code> and utilized by Tailwind.</p>
      <p style={{ fontFamily: 'Inter, sans-serif' }}>
        <strong>Sans Serif (Inter):</strong> The quick brown fox jumps over the lazy dog.
      </p>
      <p style={{ fontFamily: 'JetBrains Mono, monospace' }}>
        <strong>Monospace (JetBrains Mono):</strong> The quick brown fox jumps over the lazy dog. 0123456789
      </p>
    </section>

    <section>
      <h2>Heading Levels (via <code>@tailwindcss/typography</code> plugin)</h2>
      <h1>Heading 1</h1>
    ...
    <section>
      <h2>Other Typographic Elements (via <code>@tailwindcss/typography</code> plugin)</h2>
      <p>
        This is a paragraph with a <a href="#">link</a>. And some <strong>bold text</strong> and <em>italic text</em>.
      </p>
      <blockquote>
        This is a blockquote. It's typically used for highlighting a section of text from another source.
      </blockquote>
      <ul>
