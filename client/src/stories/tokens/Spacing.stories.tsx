...
const SpacingVisualizer = () => (
  <div>
    <h1>Spacing Units</h1>
    <p>This visualizes Tailwind CSS spacing tokens, including defaults and custom extensions from <code>tailwind.config.js</code>.</p>
    <p>The value in parenthesis is the actual size (e.g. 1rem = 16px if base font size is 16px).</p>
    <br />
