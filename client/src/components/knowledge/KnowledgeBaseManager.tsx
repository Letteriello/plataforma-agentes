...
const KnowledgeBaseManager: React.FC = () => {
  return (
    <Card className="h-full">
      {' '}
      {/* Adicionado h-full para ocupar altura da aba */}
      <CardHeader>
        <CardTitle>Gerenciador de Base de Conhecimento (RAG)</CardTitle>
        <CardDescription>
          Gerencie suas fontes de conhecimento para habilitar a funcionalidade
          de RAG (Retrieval Augmented Generation) em seus agentes.
        </CardDescription>
      </CardHeader>
      <CardContent>
