...
export const AssociatedWithInput: Story = {
  render: (args) => (
    <div className="grid w-full max-w-sm items-center gap-1.5">
      <Label {...args} htmlFor="email-input">Email Address</Label>
...
export const AssociatedWithCheckbox: Story = {
  render: (args) => (
    <div className="flex items-center space-x-2">
      ...
      <Label {...args} htmlFor="terms-checkbox">Accept terms and conditions</Label>
    </div>
  ),
  args: {
...
export const RequiredMarker: Story = {
  ...
  args: {
   ...
   parameters: {
    docs: {
      description: {
        story: 'Demonstrates a common pattern for indicating required fields. The asterisk is not part of the Label component itself.',
      },
    },
  },
};
...
export const WithDisabledPeerInput: Story = {
  render: (args) => (
     <div className="grid w-full max-w-sm items-center gap-1.5">
      <Label {...args} htmlFor="disabled-input-example">Your Name (disabled input)</Label>
      <Input type="text" id="disabled-input-example" placeholder="Cannot type here" disabled />
    </div>
  ),
  args: {
