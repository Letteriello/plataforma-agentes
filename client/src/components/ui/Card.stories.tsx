  ...
  render: (args) => (
    <Card {...args} className="w-[380px]">
      ...
      <CardContent>
        ...
        <p className="mt-2">For example, some more text, lists, or other components.</p>
      </CardContent>
      <CardFooter>
...
export const SimpleContent: Story = {
  render: (args) => (
    <Card {...args} className="w-[300px]">
      ...
      <CardContent className="grid gap-4">
        ...
        <div>
            <p className="text-sm text-muted-foreground p-4">Email notifications are handled in your profile settings.</p>
        </div>
      </CardContent>
      <CardFooter>
        <Button className="w-full">
          <CheckIcon className="mr-2 h-4 w-4" /> Mark all as read {/* Placeholder */}
        </Button>
      </CardFooter>
    </Card>
  ),
  ...
  decorators: [
    (Story) => {
      ...
      // @ts-ignore
      if (typeof BellIcon === 'undefined') global.BellIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"></path><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"></path></svg>;
      // @ts-ignore
      if (typeof CheckIcon === 'undefined') global.CheckIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>;
      // @ts-ignore
      if (typeof Switch === 'undefined') global.Switch = () => <div style={{width: 40, height:20, borderRadius: 10, backgroundColor: '#ccc'}} data-testid="switch-placeholder"/>;
      return <Story />;
    },
  ],
};
  ...
  render: (args) => (
    <Card {...args} className="w-[300px] text-center">
      <CardContent className="p-6">
        ...
        <p className="text-muted-foreground mt-1">Useful for simple displays.</p>
      </CardContent>
    </Card>
  ),
  args: {},
