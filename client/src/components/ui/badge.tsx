  ...
  "inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        // LLM specific
        llm: 
          "border-transparent bg-purple-50 text-purple-700 dark:bg-purple-900/20 dark:text-purple-400",
        tool: 
          "border-transparent bg-indigo-50 text-indigo-700 dark:bg-indigo-900/20 dark:text-indigo-400",
        user: 
          "border-transparent bg-sky-50 text-sky-700 dark:bg-sky-900/20 dark:text-sky-400",
      },
      size: {
