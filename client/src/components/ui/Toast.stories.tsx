      ...
      <Button
        ...
        onClick={() => {
          toast({
            ...
            description: 'A new version of the software is available for download.',
            action: <ToastAction altText="UpdateNow" onClick={() => alert('Update clicked!')}>Update Now</ToastAction>,
      ...
      <Button
        ...
        onClick={() => {
          toast({
            ...
            description: 'This toast will not dismiss automatically. Please click the close button.',
            duration: 0, // 0 means no auto-dismiss
            action: <ToastAction altText="Dismiss" onClick={() => { /* Logic to dismiss if not using default close */ }}>OK</ToastAction>,
          });
        }}
      >
