    ...
    <Dialog {...args}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            This is a description for the default dialog. You can add more
            details here. Make changes to your profile here. Click save when
            you're done.
          </DialogDescription>
        </DialogHeader>
  ...
  render: (args) => (
    <Dialog {...args}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="py-4">
          <p>
            Your submission has been received successfully. We will review it
            shortly.
          </p>
        </div>
        <DialogFooter>
  ...
  render: (args) => (
    <Dialog {...args}>
      ...
      <DialogContent className="sm:max-w-2xl">
        {' '}
        {/* Use Tailwind class for wider dialog */}
        <DialogHeader>
