...
import { ContextPanelData } from '@/components/context/types';
...
export function AgentSelector({ agents, selectedAgentId, onSelectAgent, className }: AgentSelectorProps) {
  ...
  return (
    <div className={className}>
      ...
      >
        <SelectTrigger className="w-[280px]"> {/* Largura pode ser ajustada */}
